...
export const verifyToken = async (token) => {
  axios
    .get("https://moncinema.herokuapp.com/users/verifytoken", {
...
export const getPopularMovies = async (token) => {
  try {
    const res = await axios.get(`${baseURL}movies/popular/2`, {
      headers: {
...
export const searchMovie = async (movie, token, pages) => {
  try {
    const res = await axios.get(`${baseURL}movies/search/${movie}/${pages}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const getMovieCredits = async (id, token) => {
  try {
    const res = await axios.get(`${baseURL}movies/${id}/credits`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const getMovieVideos = async (id, token) => {
  try {
    const res = await axios.get(`${baseURL}movies/${id}/videos`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const getMovieRecommendations = async (id, token) => {
  try {
    const res = await axios.get(`${baseURL}movies/${id}/recommendations`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const getUserAvatar = async (id) => {
  try {
    const res = await axios.get(`${baseURL}users/getAvatar/${id}`, {
      headers: {
...
export const postMovieComments = async (
  author,
  author_id,
  comment,
  movie_id,
  ...
  try {
    const res = await axios.post(
      `${baseURL}comment/newComment`,
      { author, author_id, comment, movie_id, avatar },
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const topRatedMovies = async (page, token) => {
  try {
    const res = await axios.get(`${baseURL}movies/top-rated/${page}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const actorInfos = async (id, token) => {
  try {
    const res = await axios.get(`${baseURL}movies/actor/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const actorInfosMovies = async (id, token) => {
  try {
    const res = await axios.get(`${baseURL}movies/actor/${id}/movies`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
